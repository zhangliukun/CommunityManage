...
<body>
						...
						<div class="container-fluid">
							...
							<div class="nav-collapse collapse navbar-responsive-collapse">
								<ul class="nav">
									...
									<li class="active"><a href="#">楼宇列表</a></li>
								</ul>
								<ul class="nav pull-right">
									...
									<li class="dropdown"><a class="dropdown-toggle"
										...
										<ul class="dropdown-menu">
											...
											<li><a href="/tableupload/user/addBuilding/${areaId}">楼宇</a></li>
										</ul></li>
								</ul>
							</div>
						</div>
	...
	<table id="example" class="table table-striped table-bordered compact"
		...
		<tbody>
			<c:forEach items="${buliding_arrays}" var="array1"
				varStatus="loopCounter">
				<tr>
					<td><c:out value="${array1.areaId}" /></td>
					<td><a href="/tableupload/user/alarmlist/${array1.buildingId}">${array1.buildingNumber}</a></td>
					<td><c:out value="${array1.buildingX}" /></td>
					<td><c:out value="${array1.buildingY}" /></td>
					<td><a
						href="/tableupload/user/editBuilding/${array1.buildingId}">编辑</a>
						&nbsp;&nbsp;&nbsp; <a
						href="/tableupload/user/showBuildingImage/${array1.buildingId}">图片</a></td>
				</tr>
